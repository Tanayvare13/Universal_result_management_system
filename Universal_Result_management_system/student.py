...
class studentClass:
    def __init__(self,root):
        ...
        self.root.geometry("1300x580+90+160")
        ...
        self.txt_Roll=Entry(self.root,textvariable=self.var_roll,font=("goudy old style",15,'bold'),bg='#f0ffff')
        self.txt_Roll.place(x=150,y=60,width=200)
        txt_Name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=150,y=100,width=200)
        txt_Email=Entry(self.root,textvariable=self.var_email,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=150,y=140,width=200)
        ...
        self.fetch_subject()
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=480,y=60,width=200)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=480,y=100,width=200)
        txt_addmission=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=480,y=140,width=200)
        ...
        txt_Search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=870,y=60,width=180)
