...
class SubjectClass:
    def __init__(self,root):
        ...
        self.txt_subject_name=Entry(self.root,textvariable=self.var_subject,font=("goudy old style",15,'bold'),bg='#f0ffff')
        self.txt_subject_name.place(x=150,y=60,width=200)
        txt_subject_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=150,y=100,width=200)
        txt_subject_faculty=Entry(self.root,textvariable=self.var_faculty,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=150,y=140,width=200)
        self.txt_subject_description=Text(self.root,font=("goudy old style",15,'bold'),bg='#f0ffff')
        ...
        txt_Search_subjectName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg='#f0ffff').place(x=870,y=60,width=180)
