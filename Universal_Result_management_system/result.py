...
class resultClass:
    def __init__(self,root):
        ...
        txt_Name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",20,'bold'),bg='#f0ffff',state="readonly").place(x=280,y=160,width=320)
        txt_Subject=Entry(self.root,textvariable=self.var_subject,font=("goudy old style",20,'bold'),bg='#f0ffff',state="readonly").place(x=280,y=220,width=320)
        txt_Marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style",20,'bold'),bg='#f0ffff').place(x=280,y=280,width=320)
        txt_full_Marks=Entry(self.root,textvariable=self.var_full_Marks,font=("goudy old style",20,'bold'),bg='#f0ffff').place(x=280,y=340,width=320)
